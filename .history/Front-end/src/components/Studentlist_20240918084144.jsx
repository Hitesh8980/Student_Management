...
function StudentList() {
  ...
  useEffect(() => {
    setFilteredStudents(students); // Ensure all students are displayed initially
    applyFilters();
  }, [students, filters]);
  ...
  <tr key={students.admissionNumber}>
    <td>{students.name}</td>
    <td>{students.age}</td>
    ...
    <td>
      <QRCodeGenerator value={students.admissionNumber} />
    </td>
    <td>
      <Button variant="danger" onClick={() => handleDelete(students.admissionNumber)}>
        Delete
      </Button>
    </td>
  </tr>
